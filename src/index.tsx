...
// TODO: На страницу регистрации не работает автоматическая авторизация после регистрации, санки поправить
// TODO: Сделать плавное появление модалок
// TODO: Стили на модалку авторизации накинуть
// TODO: У модалок стили разделить, чтобы корзина выезжала сбоку без фона затемнения
// TODO: В корзине написать логику
// TODO: Отображение количества товара в корзине на иконке
// TODO: Пагинация
...
// TODO: На странице товаров поправить стили у карточек, чтобы все одинаковые были и границы при наведении поправить
